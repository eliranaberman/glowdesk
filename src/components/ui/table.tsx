...
>(({ className, ...props }, ref) => (
  <thead 
    ref={ref} 
    className={cn(
      "[&_tr]:border-b [&_tr]:border-border/30 [&_tr]:bg-accent/10 text-muted-foreground sticky top-0 z-10",
      className
    )} 
    {...props} 
  />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <th
      ref={ref}
      className={cn(
        "h-12 px-3 md:px-4 text-right align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0",
