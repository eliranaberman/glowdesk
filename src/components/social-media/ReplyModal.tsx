    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-4 flex-1 overflow-hidden">
          <ScrollArea className="bg-muted/30 p-3 rounded-lg h-[300px]">
            <div className="flex gap-3 items-start mb-6">
              <div className="w-10 h-10 rounded-full overflow-hidden flex-shrink-0">
                <img src={message.avatar} alt={message.sender} className="w-full h-full object-cover" />
              </div>
              <div className="bg-muted/50 p-4 px-5 rounded-lg max-w-[85%]">
                <p className="text-base font-medium mb-1">{message.sender}</p>
                <p className="text-base leading-relaxed mb-2">{message.message}</p>
            ...
            {message.id % 2 === 0 && (
              <>
                <div className="flex justify-end mb-6">
                  <div className="bg-primary/10 p-4 px-5 rounded-lg max-w-[85%]">
                    <p className="text-base leading-relaxed mb-2">תודה שפנית אלינו! איך נוכל לעזור?</p>
